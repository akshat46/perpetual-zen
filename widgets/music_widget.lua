-- base widget https://github.com/lawsdontapplytopigs/dotfiles/blob/master/awesome/piglets/music.lua
...
-- --song_status.font = beautiful.titlefont .. " 14" or "sans 14"
--
-- local music_info = wibox.widget.textbox("Loading...")
-- --song_status.font = beautiful.fontname .. " 10" or "sans 10"
--
-- local playpause = "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause"
--
...
local toggle_button = wibox.widget.imagebox(beautiful.play_button_icon)
toggle_button.forced_height = button_size
toggle_button.forced_width = button_size
toggle_button.layout = wibox.layout.fixed.vertical
...
next_button.layout = wibox.layout.fixed.vertical
...
-- placed in)
music.music_widget = wibox.widget({
    {
        --prev_button,
        toggle_button,
        next_button,
...
spotify_widget.main_widget = wibox.widget({
    -- {
    --     prev_button,
    --     toggle_button,
    --     --next_button,
